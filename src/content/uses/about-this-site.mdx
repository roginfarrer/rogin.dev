...
export const styles = {
  slider: css({
    "--divider-width": "3px",
    "--divider-color": "token(colors.accent11)",
  ...
  first: css({
    ...
    overflow: "hidden",
    height: "100%",
    "--top-border": "calc(1lh + 1em)",
    paddingTop: "var(--top-border)",
  }),
  firstLabel: css({
    margin: "0 !important",
    position: "absolute",
  ...
  second: css({ position: "relative", paddingTop: "calc(1lh + 1em)" }),
  secondLabel: css({
    margin: "0 !important",
    position: "absolute",
    top: "0",
...
<div slot="first" class={styles.first}>
  ...
  <p class={styles.firstLabel}>Before</p>
</div>
<div slot="second" class={styles.sescond}>
  <Image src={newSite} alt="" />
  <p class={styles.secondLabel}>Updated Februrary 2024</p>
</div>
<svg
  slot="handle"
  class={styles.handle}
